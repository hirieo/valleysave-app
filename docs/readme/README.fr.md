...
> [!NOTE]
> **📱 iOS :** Elle est déjà prête. Ce qui manque, ce sont les 99 USD/an qu'Apple demande pour le droit d'entrée — [file un coup de main sur Ko-fi](https://ko-fi.com/hirieo) et iOS rejoint la fête.
