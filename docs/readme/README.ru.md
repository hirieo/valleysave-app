...
> [!NOTE]
> **📱 iOS:** Приложение ValleySave для iPhone/iPad уже существует, но для публикации в App Store требуется лицензия разработчика Apple (99 USD/год, ~99 €). Для покрытия этих расходов будет запущена краудфандинговая кампания.
