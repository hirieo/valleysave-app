...
[![Ko-fi](https://img.shields.io/badge/Ko--fi-%E8%AF%B7%E6%88%91%E5%96%9D%E5%92%96%E5%95%A1-29ABE0?logo=ko-fi&logoColor=white)](https://ko-fi.com/hirieo)
...
<img src="../screenshots/valleysave-saves-screen.png" alt="ValleySave 主界面：显示 Stardew Valley 存档的游戏时长、技能，以及本设备与 Google Drive 之间的同步状态" width="820">
...
- 🔒 **隐私优先** — ValleySave 只会碰自己的 `ValleySave/` 文件夹和你明确分享的内容。为了支持共享农场功能，Google 要求完整的 Drive 权限，但代码从不查看其他任何内容。
...
>
> 像皮埃尔一样，但不加价：ValleySave 完全免费，没有广告也没有订阅，由我一个人花了 7 个月做出来。如果它曾经帮你保住过存档，请我喝杯 [Ko-fi 咖啡](https://ko-fi.com/hirieo) 吧 —— 这就是让我每天早上有动力继续做下去的原因。☕

## 工作原理

1. **连接** — 关联你自己的 Google 账号（OAuth）。
