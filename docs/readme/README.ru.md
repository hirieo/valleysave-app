...
[![Ko-fi](https://img.shields.io/badge/Ko--fi-%D0%9A%D1%83%D0%BF%D0%B8%D1%82%D0%B5%20%D0%BC%D0%BD%D0%B5%20%D0%BA%D0%BE%D1%84%D0%B5-29ABE0?logo=ko-fi&logoColor=white)](https://ko-fi.com/hirieo)
...
<img src="../screenshots/valleysave-saves-screen.png" alt="Главный экран ValleySave: сохранение фермы Stardew Valley с временем игры, навыками и состоянием синхронизации между этим устройством и Google Drive" width="820">
...
- 🔒 **Приватность прежде всего** — ValleySave трогает только свою папку `ValleySave/` и то, чем вы явно поделились. Google требует полный scope Drive для поддержки общих ферм, но код никогда не смотрит больше никуда.
...
>
> Как Пьер, только без завышения цен: ValleySave бесплатен, без рекламы и подписок, сделан одним человеком за 7 месяцев. Если он хоть раз выручил вас с сохранениями, угостите меня [кофе на Ko-fi](https://ko-fi.com/hirieo) — именно это поднимает меня по утрам продолжать работу. ☕

## Как это работает

1. **Подключите** — привяжите свой аккаунт Google (OAuth).
