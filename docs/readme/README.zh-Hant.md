...
[![Ko-fi](https://img.shields.io/badge/Ko--fi-%E8%AB%8B%E6%88%91%E5%96%9D%E5%92%96%E5%95%A1-29ABE0?logo=ko-fi&logoColor=white)](https://ko-fi.com/hirieo)
...
- 🔒 **隱私優先** — ValleySave 只會碰自己的 `ValleySave/` 資料夾和你明確分享的內容。為了支援共享農場功能，Google 要求完整的 Drive 權限，但程式碼從不查看其他任何內容。
...
> [!NOTE]
> **📱 iOS：** 應用程式早就做好了，缺的是 Apple 收的每年 99 美元發布費 —— [到 Ko-fi 支持一下](https://ko-fi.com/hirieo)，iOS 就能加入了。
>
> 像皮埃爾一樣，但不加價：ValleySave 完全免費，沒有廣告也沒有訂閱，由我一個人花了 7 個月做出來。如果它曾經幫你保住過存檔，請我喝杯 [Ko-fi 咖啡](https://ko-fi.com/hirieo) 吧 —— 這就是讓我每天早上有動力繼續做下去的原因。☕

## 運作方式

1. **連接** — 連結你自己的 Google 帳號（OAuth）。
