...
[![Ko-fi](https://img.shields.io/badge/Ko--fi-Spendier%20mir%20einen%20Kaffee-29ABE0?logo=ko-fi&logoColor=white)](https://ko-fi.com/hirieo)
...
<img src="../screenshots/valleysave-saves-screen.png" alt="ValleySave-Hauptbildschirm: ein Stardew-Valley-Spielstand mit Spielzeit, Fähigkeiten und Sync-Status zwischen diesem Gerät und Google Drive" width="820">
...
- 🔒 **Privatsphäre zuerst** — ValleySave rührt nur den eigenen `ValleySave/`-Ordner und das an, was du ausdrücklich teilst. Google verlangt den vollen Drive-Scope, um geteilte Farmen zu unterstützen, aber der Code schaut nie woanders hin.
...
> [!NOTE]
> **📱 iOS:** Ist schon fertig. Was fehlt, sind die 99 USD/Jahr, die Apple für die Veröffentlichung verlangt — [hilf mit auf Ko-fi](https://ko-fi.com/hirieo), dann darf iOS mitfeiern.
>
> Wie Pierre, nur ohne die Preise hochzutreiben: ValleySave ist kostenlos, ohne Werbung und ohne Abos, gebaut von einer einzigen Person in 7 Monaten. Wenn es dir schon mal aus der Patsche geholfen hat, spendier mir einen [Kaffee auf Ko-fi](https://ko-fi.com/hirieo) — das bringt mich morgens in Schwung, um weiterzumachen. ☕

## So funktioniert's

1. **Verbinden** — verknüpfe dein eigenes Google-Konto (OAuth).
